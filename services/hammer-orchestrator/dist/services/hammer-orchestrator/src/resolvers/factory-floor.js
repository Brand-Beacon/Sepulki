...
exports.factoryFloorResolvers = {
    ...
    FactoryFloor: {
        ...
        widthMeters: (parent) => parent.width_meters,
        heightMeters: (parent) => parent.height_meters,
        scaleFactor: (parent) => parent.scale_factor,
        originX: (parent) => parent.origin_x,
        originY: (parent) => parent.origin_y,
        blueprintUrl: (parent) => parent.blueprint_url,
        blueprintType: (parent) => parent.blueprint_type,
