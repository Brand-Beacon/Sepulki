...
export const speedLimiter = slowDown({
  ...
  keyGenerator: (req: Request) => {
    // Use the first trusted proxy IP when present, otherwise fall back to helper for IPv4/IPv6 support
 ...
 */
export const requestSizeLimit = process.env.MAX_REQUEST_SIZE || '100kb';

/**
 * Timeout configuration
 * Prevents slow loris attacks
 */
export const requestTimeout = parseInt(process.env.REQUEST_TIMEOUT || '30000', 10);
